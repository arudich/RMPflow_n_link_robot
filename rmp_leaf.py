...
RMP leaf nodes can be transferred without modification to any RMP Tree.
The nodes that control 2D points are used to control 2D points on my n-link robot,
and the computational graph takes care of resolving those motions in terms of joint actuation

I added a JointLimit RMPLeaf according to the formulas found in https://arxiv.org/pdf/1811.07049.pdf
"""
